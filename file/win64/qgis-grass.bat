...
IF "%1" == "" (start "Quantum GIS" /B %OSGEO4W_ROOT%\bin\qgis.bat --profiles-path %DRV_LTR%\qgisconfig) ELSE (start "Quantum GIS" /B %OSGEO4W_ROOT%\bin\qgis.bat --profiles-path %DRV_LTR%\qgisconfig --project %1)
