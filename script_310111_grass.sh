...
versione=QGIS-OSGeo4W-3.10.11-1-Setup-x86_64
...
curl -L "https://github.com/pigreco/QGIS_portable_3x/raw/master/file/win64/qgis-grass.bat" >qgis-ltr-grass.bat
#cambio cartella
cd qgis/bin
...
7z a OSGeo4W64_310111-ltr_grass78.7z OSGeo4W