...
curl http://download.osgeo.org/qgis/win64/QGIS-OSGeo4W-3.4.9-1-Setup-x86_64.exe >QGIS-OSGeo4W-3.4.9-1-Setup-x86_64.exe
7z x QGIS-OSGeo4W-3.4.9-1-Setup-x86_64.exe
mv '$_25_' OSGeo4W
